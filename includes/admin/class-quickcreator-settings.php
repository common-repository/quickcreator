...
class Quickcreator_Settings {
	...
	private function return_default_content_importer_settings() {
		...
		$defaults = array(
			'quickcreator_url'                          => 'https://app.quickcreator.io',
			'quickcreator_api_url'                      => 'https://api.quickcreator.com/landingpage-service',
			'default_content_editor'              => Parsers_Controller::AUTOMATIC,
			'default_post_author'                 => $users[0]->ID,
			'default_post_status'                 => 'draft',
			'default_category'                    => false,
			'default_tags'                        => false,
			'quickcreator_gsc_meta_script'              => false,
			'quickcreator_gsc_data_collection_interval' => 7,
		);
